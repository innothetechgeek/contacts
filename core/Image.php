...
class Image{
    ...
    public static function createContactCard($image_options = [],$text_options = []){
       ...
       if(empty($text_options)) $text_options["lines"] = [
            ...
            "line2" => [
                "emailAddress" => "nickibella@gmail.com",
                "position" => '5, 15, 45'
            ],            
    ...
    public static function createImage($image_options,$text_color = [], $text_options =[]){
         ...
         if(!empty($text_options)){
            ...
            $position = explode(",",$text_options['lines']['line1']["position"]);
            $position2 =  explode(",",$text_options['lines']['line2']["position"]);
            $line1 = $text_options['lines']['line1']['name'];
            $line2 = $text_options['lines']['line2']['emailAddress'];

            // Function to create image which contains string.
            imagestring($image, $position[0],$position[1], $position[2] ,  $line1, $text_color); 
            imagestring($image,  $position2[0],$position2[1], $position2[2], $line2, $text_color); 
